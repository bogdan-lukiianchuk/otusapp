package com.otus.homework.warehouseservice.advice;

import com.otus.homework.warehouseservice.exceptions.ExpirationException;
import com.otus.homework.warehouseservice.exceptions.InvalidTokenException;
...
public class ControllerAdvice {
    ...
    public String handleReservationException(ReservationException e) {
        log.error("handler catch", e);
        return e.getMessage();
    }
